  ...
  <div class="bg-white">
    ...
    <div class="flex flex-col items-center justify-center shadow-md px-5 py-10">
      ...
      <div class="mx-auto w-full lg:w-3/5 relative my-3">
        ...
        >
        <textarea
          class="w-full rounded-md h-28 border-gray-300 focus:ring-0 focus:outline-none focus:border-explorerGreen-300"
          type="text"
          name="about"
          id="about"
        ></textarea>
      ...
      <div class="mx-auto w-full lg:w-3/5 relative my-3">
        <span class="text-lg text-gray-700 block"
          >Delivery within sellers region available
        </span>
        <input
          class="inline-block focus:ring-0 focus:outline-none mr-2"
          type="checkbox"
          name="is-close"
          id="is-close"
        />
        <label for="is-close">Yes </label>
      </div>
