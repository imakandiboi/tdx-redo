    ...
    <div class="flex flex-col shadow-md px-7 py-10">
      <div class="w-full lg:w-3/5 relative my-3 switch switch--2">
        <label class="switch__label h-full flex items-center">
          ...
          <span class="text-gray-700 text-lg">Recieve Messages</span>
        </label>
      </div>

      <div class="w-full relative my-3">
        <p class="text-lg text-gray-400 leading-10 text-justify">
          Chats help your customers to get in touch with you through messages on
          Jiji platform. Enable this option to get messages from new customers.
        </p>

        <p class="text-lg font-bold text-gray-700 text-justify">
          If you don`t reply to your customers for a while, chats will be
          disabled automatically (existing chats will stay active)
        </p>
      </div>
    </div>
  </div>
